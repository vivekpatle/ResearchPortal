        ...
        <div class="col-xs-12 col-sm-12 col-md-4 well well-sm ">
            ...
            <div class="row">
                <div class="col-xs-6 col-md-6">
                    <input class="form-control" name="sname" placeholder="First Name" type="text" required autofocus />
                </div>
                <div class="col-xs-6 col-md-6">
                    <input class="form-control" name="lname" placeholder="Last Name" type="text" required />
                        ...
                        <div class="row">
                         <div class="col-xs-6 col-md-6">
                            <input class="form-control"  placeholder="Department/College" type="text" required name="college" />

                </div>
                <div class="col-xs-6 col-md-6">
            <input class="form-control" name="rollnumber" placeholder="Enrollment Number" type="text" required />
                </div>
