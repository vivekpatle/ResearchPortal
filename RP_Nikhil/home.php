            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel" style="font-family: 'Slabo 27px', serif; font-size: 1.5em; font-style: bold;"> <i class="fa fa-sign-in" aria-hidden="true"></i> Log in </h4>
                    </div>
                    <!-- /.modal-header -->
                        ...
                        <form role="form">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="uLogin" name="uname" placeholder="Enrollment Number">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="password" class="form-control" id="uPassword" name="psw" placeholder="Password">
                    ...
                    <div class="modal-footer">
                        ...
                        <br>
                        <a href="signup1.php">New user? Register Here</a>
                        <div class="progress">
