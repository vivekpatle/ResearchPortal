...
<body>
    ...
    <li><a href="research_search.php" class="hvr-underline-from-center" id="jake"><i class="fa fa-university" aria-hidden="true"></i> Research Portal </a>
				...
				<li>
					<a href="logout.php" id="jake" class="hvr-underline-from-center">Logout  <i class="fa fa-sign-out" aria-hidden="true"></i></a>
...
<p class=" text-info"><?php date_default_timezone_set('Asia/Kolkata'); echo date("Y-M-d g:i a"); ?> </p>
      </div>
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="images/student_profile/20781.jpg" class="img-circle img-responsive"> </div>
                  ...
                  <table class="table table-user-information">
                    <tbody id="jake" style="color:black; font-size: 1em">
                      ...
                      <tr>
                        ...
                        <td><strong>Enrolment ID</strong></td>
                        <td><?php echo $username; ?><br><br>
                        </td>
